...
<template>
  <header :class="[{ isactive: isactive }, 'animation']">
    ...
    >
      ...
      >
        -_-G<span class="text-orange-500">Trcker-_-</span>
      </h1>
      ...
      <nuxt-link
        to="/track"
        class="extra-small-screen bg-orange-500 text-white px-7 py-2 text-sm rounded capitalize"
      >
        <i class="fa-brands fa-accessible-icon animate-bounce"></i>
        track product</nuxt-link
      >
    </nav>
  </header>
</template>
